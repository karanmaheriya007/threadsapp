    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const res = await fetch(`/api/users/update/${user._id}`, {
                ...
                body: JSON.stringify({
                    ...inputs,
                    profilePic: imgUrl // Update profilePic with the imgUrl
                })
            });
            ...
            setUser(data);
            //if we reload page then living data as it is due to localStorage
                ...
                <Stack
                    ...
                    <FormControl id="userName">
                        ...
                        <Stack direction={['column', 'row']} spacing={6}>
                            <Center>
                                <Avatar size="xl"
                                    boxShadow={"md"} src={imgUrl || user.profilePic} />
                            </Center>
                            <Center w="full">
                    ...
                    <FormControl>
                        ...
                        <Input
                            placeholder="karanmaheriya@gmail.com"
                            _placeholder={{ color: 'gray.500' }}
                    ...
                    <FormControl>
                        ...
                        <Input
                            ...
                            _placeholder={{ color: 'gray.500' }}
                            type="text" onChange={(e) => setInputs({ ...inputs, bio: e.target.value })}
                            value={inputs.bio}
                        />
                    </FormControl>
                    <FormControl>
